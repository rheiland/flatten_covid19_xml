...
#--------------------------------------------------
print("\n===================================================================================")
print("\n--- Phase -1: Verify all substrates appear in the <secretion> for 'default' cell_definition\n")
...
if set(substrates) == set(default_substrates):
    ...
    print("\n *** Error: there is a mismatch in the defined substrates and the phenotype//secretion substrates in the default cell_def.\n")
    ...
    print()
    print("\n *** You need to fix this and try again. \n\n")
    sys.exit()
